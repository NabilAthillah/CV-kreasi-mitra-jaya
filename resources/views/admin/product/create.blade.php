                ...
                <div class="card-body">
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan Nama Product" class="w-full p-2 border rounded">
                            @error('name')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="price" name="price" placeholder="Masukkan Harga Product" value="{{ old('price') }}" class="w-full p-2 border rounded">
                            @error('price')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="stock" name="stock" placeholder="Masukkan Stok Product" value="{{ old('stock') }}" class="w-full p-2 border rounded">
                            @error('stock')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" placeholder="Masukkan Deskripsi Product" class="w-full p-2 border rounded" value="{{ old('description') }}"></textarea>
                            @error('description')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category" id="category" class="w-full p-2 border rounded">
                                <option readonly>Silahkan pilih kategori</option>
