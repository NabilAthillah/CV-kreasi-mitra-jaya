...
<body class="bg-white">
    <main class="flex flex-col gap-10 justify-center items-center h-screen">
        ...
        <form action="{{ route('actionlogin') }}" method="POST" class="flex flex-col gap-10">
            @csrf
            ...
            <button class="font-bold font-roboto text-lg bg-[#2738b2] w-full py-1 rounded-full text-white border-2 border-[#273b82] hover:bg-white hover:text-[#273b82] transition-colors duration-200">Log In</button>
